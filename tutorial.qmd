...
To get started, we first need to create a pushover account at [https://pushover.net/signup](https://pushover.net/signup). A free 30 day trial is available. After that, a one-time payment of $5.99 is required. You can send up to 10,000 notifications a month.
